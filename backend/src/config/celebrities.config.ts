...
export const DEFAULT_CELEBRITIES: Celebrity[] = [
  ...
  },
  {
    ...
    name: 'Kwak Noh-Jung',
    nameZh: '郭鲁正',
    aliases: ['Noh-Jung Kwak', 'Kwak', 'SK Hynix CEO'],
    primaryTicker: '000660.KS',
    relatedTickers: ['005930.KS', 'NVDA', 'TSM', 'MU'],
    searchKeywords: [
      'SK Hynix',
      'SK海力士',
      'HBM',
  ...
  },
  {
    ...
    nameZh: '桑杰·梅赫罗特拉',
    aliases: ['Mehrotra', 'Micron CEO'],
    primaryTicker: 'MU',
    relatedTickers: ['000660.KS', '005930.KS', 'NVDA', 'AMD'],
    searchKeywords: [
      'Micron',
      '美光',
      'HBM',
